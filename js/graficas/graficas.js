...
const Vista = {
    ...
    mostrarRegistrosTablas: function (data) {
        ...
        const groupedData = data.reduce((accumulator, item) => {
            const columnValue = item.irradiat; // Reemplaza 'nombre_de_columna' con el nombre real de la columna
    ...
    mostrarRegistrosTablas2: function (data) {
        // Paso 2: Agrupar los datos por valor de la columna
        const groupedData = data.reduce((accumulator, item) => {
            const columnValue = item.deg_malig; // Reemplaza 'nombre_de_columna' con el nombre real de la columna
